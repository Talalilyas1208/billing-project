  ...
  {
    title: "Account", // Labelled "Account" in screenshot, maps to revenueCategory
    dataIndex: "revenueCategory",
    key: "revenueCategory",
    render: (text) => <span style={{ color: '#1f1f1f' }}>{text || 'Sales'}</span>,
  },
  {
    title: "Price",
    key: "price",
    align: 'right', // Screenshot shows price on the right
    render: (_, record) => (
